...
public class FirebaseHelperRiwayat2 {
    ...
    public FirebaseHelperRiwayat2(Context c, String DB_URL, ListView listView){
        this.c=c;
        this.DB_URL=DB_URL;
    ...
    public void getUpdate(DataSnapshot dataSnapshot){
        ...
        String idPemesanan=dataSnapshot.getValue(ModelRiwayat.class).getIdPemesan();
        if (idPemesanan.equals(mUserId)){
